...
class GhostShotDataset(Dataset):
    def __init__(self, csv_path, transform=None, max_crops_per_video: int = 8):
...
def build_dataloaders(split_paths: dict, cfg: dict) -> dict:
    ...
    for split, path in split_paths.items():
        ds = GhostShotDataset(csv_path=path, transform=transforms[split])
